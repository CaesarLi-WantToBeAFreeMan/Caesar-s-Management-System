...
CREATE TABLE `users`(
    ...
    `first_nationality_id` INT UNSIGNED NOT NULL DEFAULT 233 COMMENT 'user''s first nationality id defined in nationalities table, default is USA',
...
(
    ...
    'Caesar',       'Lee',          2,              'caesar_cofounder@cjl.com',
    '+12345678900',  34,             NULL,               NULL,       1,
    '2025-01-01',   300000.00,  136,            51,
    16,                     NULL,                   227,
    233,                        TRUE
),
(
    ...
    'Alice',        'Jackson',      3,              'alice_cofounder@cjl.com',
    '+12345678901',  34,             NULL,               NULL,       2,
    '2025-01-01',   300000.00,  140,            16,
    NULL,                   NULL,                   233,
    NULL,                       TRUE
),
(
...
(
    ...
    'Caesar',       'Lee',          2,              'caesar_ceo@cjl.com',
...
(
    ...
    '+12345678902',  26,              1,                  NULL,       4,
    '2025-01-02',   200000.00,  140,            16,
    NULL,                   NULL,                   233,
    NULL,                       TRUE
),
(
    ...
    '+12345678903',  26,              1,                  1,          13,
    '2025-01-02',   150000.00,  140,            16,
    NULL,                   NULL,                   233,
    NULL,                       TRUE
),
(
    ...
    '+12345678904',  26,              1,                  1,          14,
    '2025-01-03',   150000.00,  140,            16,
    NULL,                   NULL,                   233,
    NULL,                       TRUE
),
(
    ...
    '+81312345678',  26,              1,                  1,          14,
    '2025-01-02',   100000.00,  65,             33,
    16,                     NULL,                   114,
    NULL,                       TRUE
),
(
    ...
    '+12345678905',  26,              1,                  2,          13,
    '2025-01-02',   120000.00,  140,            16,
    34,                     NULL,                   233,
    NULL,                       TRUE
),
(
    ...
    '+12345678906',  26,              1,                  2,          14,
    '2025-01-02',   100000.00,  140,            16,
    NULL,                   NULL,                   233,
    NULL,                       TRUE
),
(
    ...
    '+12345678907',  26,              1,                  2,          14,
    '2025-01-03',   120000.00,  140,            16,
    NULL,                   NULL,                   233,
    NULL,                       FALSE
),
(
...
(
    ...
    '+12345678912',  2,              2,                  4,          13,
    '2025-01-03',   200000.00,  140,            16,
    NULL,                   NULL,                   233,
    NULL,                       TRUE
),
(
...
(
    ...
    '+12345678914',  34,             2,                  4,          14,
    '2025-01-03',   300000.00,  140,            17,
    16,                     NULL,                   245,
    233,                        FALSE
),
(
    ...
    '+12345678915',  34,             2,                  5,          13,
    '2025-01-03',   300000.00,  140,            16,
    49,                     NULL,                   233,
    NULL,                       FALSE
),
(
...
(
    ...
    '+12345678917',  7,              2,                  5,          13,
    '2025-01-03',   250000.00,  140,            16,
    NULL,                   NULL,                   233,
    NULL,                       TRUE
),
(
    ...
    '+12345678918',  17,             2,                  6,          13,
    '2025-01-04',   250000.00,  140,            16,
    NULL,                   NULL,                   233,
    NULL,                       FALSE
),
(
...
(
    ...
    'Jean',         'Grey',         3,              'phoenix@cjl.com',
    '+12345678927',  8,              3,                  9,          13,
    '2025-01-04',   200000.00,  140,            16,
    NULL,                   NULL,                   233,
    NULL,                       TRUE
),
...
(
    ...
    'Alice',        'Jackson',      3,              'alice_cfo@cjl.com',
    '+12345678930',  34,             4,                  NULL,       7,
    '2025-01-04',   300000.00,  140,            16,
    NULL,                   NULL,                   233,
    NULL,                       FALSE
),
(
...
(
    ...
    'Natasha',      'Romanoff',     3,              'black_widow@cjl.com',
    '+12345678934',  1,              4,                  10,         14,
    '2025-01-04',   250000.00,  140,            16,
    NULL,                   NULL,                   233,
    NULL,                       TRUE
),
(
    ...
    'Yelena',       'Belova',       3,              'yelena_belova@cjl.com',
    '+12345678935',  1,              4,                  11,         13,
    '2025-01-04',   250000.00,  140,            16,
    NULL,                   NULL,                   233,
    NULL,                       TRUE
),
...
(
    ...
    'Bruce',        'Banner',       14,             'bruce_banner@cjl.com',
    '+12345678937',  34,             4,                  11,         14,
    '2025-01-04',   250000.00,  140,            16,
    NULL,                   NULL,                   233,
    NULL,                       TRUE
),
(
    ...
    'Wanda',        'Maximoff',     3,              'wanda_maximoff@cjl.com',
...
(
    ...
    'Gamora',       'Gamora',       3,              'gamora@cjl.com',
    '+12345678945',  7,              5,                  14,         13,
    '2025-01-04',   300000.00,  140,            16,
    NULL,                   NULL,                   233,
    NULL,                       TRUE
),
...
(
    ...
    'Mikasa',       'Ackerman',     3,              'mikasa_ackerman@cjl.com',
    '+12345678949',  7,              6,                  15,         13,
    '2025-01-05',   300000.00,  65,             33,
    16,                     NULL,                   114,
    NULL,                       TRUE
),
...
(
    ...
    'Annie',        'Leonhart',     3,              'annie_leonhart@cjl.com',
    '+12345678953',  7,              6,                  16,         14,
    '2025-01-05',   300000.00,  65,             33,
    16,                     NULL,                   114,
    NULL,                       TRUE
),
...
(
    ...
    'Sasha',        'Blouse',       3,              'sasha_blouse@cjl.com',
...
(
    ...
    'Historia',     'Reiss',        3,              'historia_reiss@cjl.com',
    '+12345678956',  7,              7,                  17,         13,
    '2025-01-05',   300000.00,  65,             33,
    16,                     NULL,                   114,
    NULL,                       TRUE
),
(
    ...
    'Christa',      'Lenz',         3,              'christa_lenz@cjl.com',
    '+12345678957',  7,              7,                  17,         14,
    '2025-01-05',   300000.00,  65,             33,
    16,                     NULL,                   114,
    NULL,                       TRUE
),
(
    ...
    'Ymir',         'Ymir',         3,              'ymir@cjl.com',
    '+12345678958',  7,              7,                  17,         14,
    '2025-01-05',   300000.00,  65,             33,
    16,                     NULL,                   114,
    NULL,                       TRUE
),
...
(
    ...
    'Ymir',         'Fritz',        3,             'ymir_fritz@cjl.com',
...
(
    ...
    'Maria',        'Fritz',        3,             'maria_fritz@cjl.com',
    '+12345678966',  2,              8,                  20,         13,
    '2025-01-05',   300000.00,  65,             33,
    16,                     NULL,                   114,
    NULL,                       TRUE
),
(
    ...
    'Rose',         'Fritz',        3,             'rose_fritz@cjl.com',
    '+12345678967',  2,              8,                  20,         14,
    '2025-01-05',   300000.00,  65,             33,
    16,                     NULL,                   114,
    NULL,                       TRUE
),
(
    ...
    'Sina',         'Fritz',        3,             'sina_fritz@cjl.com',
    '+12345678968',  2,              8,                  20,         14,
    '2025-01-05',   300000.00,  65,             33,
    16,                     NULL,                   114,
    NULL,                       TRUE
),
...
(
    ...
    'Carla',        'Yeager',       3,             'carla_yeager@cjl.com',
    '+12345678970',  2,              8,                  21,         14,
    '2025-01-05',   300000.00,  65,             33,
    16,                     NULL,                   114,
    NULL,                       TRUE
),
...
(
    ...
    'Pieck',        'Finger',       3,              'pieck_finger@cjl.com',
    '+12345678972',  7,              8,                  22,         13,
    '2025-01-05',   300000.00,  65,             33,
    16,                     NULL,                   114,
    NULL,                       TRUE
),
(
    ...
    'Gabi',         'Braun',        3,              'gabi_braun@cjl.com',
    '+12345678973',  7,              8,                  22,         14,
    '2025-01-05',   300000.00,  65,             33,
    16,                     NULL,                   114,
    NULL,                       TRUE
),
...
(
    ...
    'Yelena',       'Yelena',       3,              'yelena_aot@cjl.com',
...
(
    ...
    'Jessica',      'Jones',        3,              'jessica_jones@cjl.com',
    '+12345678977',  7,              9,                  23,         14,
    '2025-01-05',   300000.00,  140,            16,
    NULL,                   NULL,                   233,
    NULL,                       TRUE
),
(
...
(
    ...
    'Patricia',     'Walker',       3,              'patricia_walker@cjl.com',
    '+12345678979',  7,              9,                  24,         13,
    '2025-01-05',   300000.00,  140,            16,
    NULL,                   NULL,                   233,
    NULL,                       TRUE
),
